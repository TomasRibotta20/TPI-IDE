...
namespace WIndowsForm
{
    public partial class FormReportePlanes : Form
    {
        ...
        private void ConfigurarFormulario()
        {
            ...
            dgvPlanes.Font = new Font("Segoe UI", 9);
            dgvPlanes.RowTemplate.Height = 35;
            dgvPlanes.AlternatingRowsDefaultCellStyle = new DataGridViewCellStyle
            {
        ...
        private void ConfigurarColumnas()
        {
            ...
            dgvPlanes.Columns["OcupacionPorcentaje"].HeaderText = "Ocupación";
        ...
        private void BtnExportar_Click(object sender, EventArgs e)
        {
            try
            {
                if (!_todosLosPlanes.Any())
                {
                    MessageBox.Show("No hay planes disponibles para exportar.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                PdfHelper.ExportarPlanesPDF(_todosLosPlanes, _todasLasEspecialidades);
            }
            catch (Exception ex)
            {
        ...
        private void PanelGrafico_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawString("Distribución de Planes por Especialidad", titleFont, 
            ...
            g.DrawString("* Se muestran las 8 especialidades con más planes", 
