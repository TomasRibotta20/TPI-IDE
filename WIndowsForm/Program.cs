        ...
        static async Task MainAsync()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    // Después de cerrar el menú, verificar si la sesión sigue activa
                    // Si no está activa, volver al inicio del bucle (mostrar login)
                    if (!await authService.IsAuthenticatedAsync())
                    {
                        continue; // Volver al login
                    }
                    ...
                    {
                        // Si cerró el formulario pero aún está autenticado, salir
                        break;
                    }
                }
                catch (UnauthorizedAccessException ex)
                {
                    ...
                    await authService.LogoutAsync();
                    // Continuar el bucle para mostrar el login de nuevo
                }
                catch (Exception ex)
                {
