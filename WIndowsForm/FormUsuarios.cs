...
namespace WIndowsForm
{
    public partial class FormUsuarios : Form
    {
        ...
        private void ConfigurarColumnasDataGrid()
        {
            ...
            // Columnas visibles - Solo las más relevantes
        ...
        private async void EliminarUsuarioSeleccionado(DataGridView dataGridView)
        {
            ...
            // Determinar el texto a mostrar según el tipo de usuario
            string nombreMostrar = usuarioSeleccionado.TipoUsuario == "Administrador"
                ? usuarioSeleccionado.UsuarioNombre
                : $"{usuarioSeleccionado.Nombre} {usuarioSeleccionado.Apellido}";

            var resultado = MessageBox.Show(
                $"¿Está seguro que desea eliminar al usuario {nombreMostrar}?",
