...
namespace Domain.Model
{
    public class Usuario
    {
        ...
        public Usuario(int id, string username, string email, string password, Persona? persona, bool habilitado = true)
        {
            SetId(id);
            SetEmail(email);
        ...
        public Usuario(string username, string email, string password, bool habilitado = true)
        {
            SetEmail(email);
            SetPassword(password);
            SetHabilitado(habilitado);
