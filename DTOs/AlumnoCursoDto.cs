...
namespace DTOs
{
    ...
    public class AlumnoCursoDto
    {
        ...
        public string? NombreMateria { get; set; } // Agregado para facilitar uso en Blazor
        public string? DescComision { get; set; } // Agregado para facilitar uso en Blazor
        public int? AnioCalendario { get; set; } // Agregado para facilitar uso en Blazor
        public CondicionAlumnoDto Condicion { get; set; }
        public int? Nota { get; set; }
        public DateTime? FechaInscripcion { get; set; } // Para auditor�a
    }
}